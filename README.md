...
### Purpose:
The purpose of this repo is to add some setup choice on top of Omarchy to fit your needs. Your choices should be applied to a freash, upgraded base install of Omarchy.  
