...
show_ai_tool_menu() {
    ...
    declare -a ai_tools=(
        "Upscayl|Free and Open Source AI Image Upscaler - GPU Required|./bin/aitools/install-upscayl.sh|false" #tested
        ...
        "ComfyUI|Stable Diffusion Web Interface - GPU Required|./bin/aitools/install-comfyui.sh|false" #tested
    ...
    gum style --foreground 1 "Note: AI tools require a compatible GPU to function properly."
    echo ""
